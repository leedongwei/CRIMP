...
public class UploadTaskAdapter extends ArrayAdapter<QueueObject>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        cIdView.setText(context.getString(R.string.upload_activity_climber) +
                dataList.get(position).getRequest().getClimberId());
        rIdView.setText(context.getString(R.string.upload_activity_route) +
                dataList.get(position).getRequest().getRouteId());
        statusView.setText(context.getString(R.string.upload_activity_status) +
