 ...
 */
public class CrimpService2 extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent != null && !intent.getAction().equals(ACTION_BOOT_NO_INTENT)){
            Timber.d("Received intent to request data: %s",
                    intent.getSerializableExtra(SERIALIZABLE_UUID));
    ...
    public static void tryQuitService(){
