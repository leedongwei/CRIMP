...
public class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            if(result == null){
                ...
                if (mainThreadHandler != null) {
                    Message message = Message.obtain(mainThreadHandler,
                            ScanFragmentHandler.DECODE_FAIL);
                ...
                if (mainThreadHandler != null) {
                    Message message = Message.obtain(mainThreadHandler,
                            ScanFragmentHandler.DECODE_SUCCEED, result);
            ...
            if (mainThreadHandler != null) {
                Message message = Message.obtain(mainThreadHandler, ScanFragmentHandler.DECODE_FAIL);
                message.sendToTarget();
            }
        }
    }
